...
export default function HotelReceptionDeskPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-3 md:px-4 text-center">
            <div className="max-w-2xl mx-auto px-3">
              <h1 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-white line-clamp-2 md:line-clamp-none">
                Hotel Reception Desk Collection
              </h1>
              <p className="text-sm md:text-lg lg:text-xl mb-5 md:mb-6 opacity-90 text-white">
                Premium reception desks designed for hotel lobbies, combining functionality, technology, and style
              </p>
      ...
      <section className="py-6 md:py-12 bg-background">
        <div className="container mx-auto px-3 md:px-4">
          <div className="text-center mb-4 md:mb-8 px-3">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 line-clamp-2 md:line-clamp-none">Our Reception Desks</h2>
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
              Discover our comprehensive range of hotel reception desks, each designed with unique features to meet your lobby needs.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {receptionDesks.map((desk) => (
              <Card key={desk.id} className="group overflow-hidden hover:shadow-lg transition-shadow duration-300 p-0">
                <div 
                  className="relative cursor-pointer group/image overflow-hidden m-0"
                  onClick={() => handleImageClick(desk.image, desk.name)}
                >
                  <ImageWithFallback
                    src={desk.image}
                    alt={desk.name}
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-xl md:text-3xl lg:text-4xl font-bold leading-tight text-center md:text-left line-clamp-2 md:line-clamp-none">
                  Transform Your Hotel Lobby with Premium Reception Desks
                </h2>
        ...
        <div className="container mx-auto px-3 md:px-4 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-8 text-white bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              Reception Desks: Where First Impressions Meet Functionality
            </h2>
      ...
      <section className="py-10 md:py-16 bg-primary text-white">
        <div className="container mx-auto px-3 md:px-4 text-center">
          <h2 className="text-xl md:text-3xl font-bold mb-3 md:mb-4 line-clamp-2 md:line-clamp-none">Ready to Transform Your Hotel Lobby?</h2>
