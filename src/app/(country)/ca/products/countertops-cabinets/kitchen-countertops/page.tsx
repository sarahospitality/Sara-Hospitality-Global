...
const kitchenCountertops = [
  {
    id: "kct-901",
    name: "KCT-901",
    category: "Granite Countertop",
    description: "Premium granite countertop offering natural beauty and exceptional durability for hotel kitchens. Heat-resistant with timeless elegance and professional finish.",
    features: ["Natural Granite", "Heat Resistant", "Durable", "Elegant"],
    image: "https://images.unsplash.com/photo-1556911220-bff31c812dba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncmFuaXRlJTIwY291bnRlcnRvcCUyMGtpdGNoZW58ZW58MXx8fHwxNzU3NTkxMzMwfDA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Granite", "Natural", "Premium"]
  },
  {
    id: "kct-902",
    name: "KCT-902",
    category: "Quartz Countertop",
    description: "Engineered quartz countertop combining beauty with superior performance. Non-porous surface perfect for commercial hotel kitchens requiring hygiene and durability.",
    features: ["Engineered Quartz", "Non-Porous", "Hygienic", "Stain Resistant"],
    image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxxdWFydHolMjBjb3VudGVydG9wJTIwa2l0Y2hlbnxlbnwxfHx8fDE3NTc1OTEzMzN8MA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Quartz", "Hygienic", "Modern"]
  },
  {
    id: "kct-903",
    name: "KCT-903",
    category: "Stainless Steel Countertop",
    description: "Professional-grade stainless steel countertop designed for heavy-duty hotel kitchens. Ultimate hygiene with seamless construction and easy maintenance.",
    features: ["Stainless Steel", "Seamless", "Professional", "Easy Clean"],
    image: "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdGFpbmxlc3MlMjBzdGVlbCUyMGNvdW50ZXJ0b3B8ZW58MXx8fHwxNzU3NTkxMzM3fDA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Stainless", "Professional", "Hygienic"]
  },
  {
    id: "kct-904",
    name: "KCT-904",
    category: "Marble Countertop Luxury",
    description: "Luxurious marble countertop for upscale hotel kitchens and prep areas. Natural veining creates stunning visual impact with classic sophistication.",
    features: ["Natural Marble", "Luxury", "Visual Impact", "Classic"],
    image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYXJibGUlMjBjb3VudGVydG9wJTIwa2l0Y2hlbnxlbnwxfHx8fDE3NTc1OTEzNDB8MA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Marble", "Luxury", "Classic"]
  },
  {
    id: "kct-905",
    name: "KCT-905",
    category: "Solid Surface Countertop",
    description: "Versatile solid surface countertop offering seamless integration and easy maintenance. Ideal for hotel kitchens requiring modern functionality.",
    features: ["Solid Surface", "Seamless", "Versatile", "Low Maintenance"],
    image: "https://images.unsplash.com/photo-1565538810643-b5bdb714032a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzb2xpZCUyMHN1cmZhY2UlMjBjb3VudGVydG9wfGVufDF8fHx8MTc1NzU5MTM0M3ww&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Solid Surface", "Modern", "Versatile"]
  },
  {
    id: "kct-906",
    name: "KCT-906",
    category: "Butcher Block Countertop",
    description: "Traditional butcher block countertop perfect for hotel food prep areas. Natural wood surface with antimicrobial treatment and professional appeal.",
    features: ["Butcher Block", "Natural Wood", "Food Prep", "Antimicrobial"],
    image: "https://images.unsplash.com/photo-1600585154526-990dced4db0d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXRjaGVyJTIwYmxvY2slMjBjb3VudGVydG9wfGVufDF8fHx8MTc1NzU5MTM0N3ww&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Wood", "Traditional", "Food Safe"]
  }
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[40vh] overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1556911220-bff31c812dba?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxob3RlbCUyMGtpdGNoZW4lMjBjb3VudGVydG9wJTIwbHV4dXJ5fGVufDF8fHx8MTc1NzU5MTM1MHww&ixlib=rb-4.1.0&q=80&w=1080"
            alt="Kitchen Countertops Collection"
          ...
          <div className="container mx-auto px-4 sm:px-6 text-center">
            <div className="max-w-2xl mx-auto px-2 sm:px-0">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 text-white leading-tight">
                Kitchen Countertops Collection
              </h1>
              <p className="text-sm sm:text-lg lg:text-xl mb-4 sm:mb-6 opacity-90 text-white px-2 sm:px-0">
                Premium kitchen countertops designed for hotel kitchens, combining durability, hygiene, and professional performance
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-10">
            ...
            <div className="text-center">
              <div className="bg-white/95 backdrop-blur-sm p-3 sm:p-4 md:p-6 rounded-xl shadow-2xl border border-white/20">
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-primary mb-1">100%</div>
                <div className="text-xs sm:text-sm text-muted-foreground">Heat Resistant</div>
              </div>
            </div>
      ...
      <section className="py-5 sm:py-8 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4 leading-tight">Our Kitchen Countertops</h2>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
              Discover our comprehensive range of kitchen countertops, each designed with unique features to meet your hospitality kitchen needs.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {kitchenCountertops.map((countertop) => (
              <Card key={countertop.id} className="group overflow-hidden hover:shadow-lg transition-shadow duration-300 p-0">
                <div 
                  className="relative cursor-pointer group/image overflow-hidden m-0"
                  onClick={() => handleImageClick(countertop.image, countertop.name)}
                >
                  <ImageWithFallback
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex items-center justify-between gap-2">
                    <h3 className="font-bold text-base sm:text-lg">{countertop.name}</h3>
            ...
            <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
              <div>
                <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold leading-tight mb-3 sm:mb-4 text-center lg:text-left">
                  Transform Your Hotel with Premium Countertop Solutions
                </h2>
                <p className="text-sm sm:text-lg text-muted-foreground mb-4 sm:mb-8 text-center lg:text-left">
                  Discover our comprehensive range of hotel kitchen countertops designed to elevate your kitchen performance and hygiene standards. From natural granite to engineered quartz, we have everything you need.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
                <ImageWithFallback
                  ...
                  alt="Modern luxury kitchen countertop"
                  className="w-full h-full object-cover"
                  width={800}
                  height={600}
                />
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            ...
            <p className="text-sm sm:text-lg text-muted-foreground max-w-3xl mx-auto px-2 sm:px-0">
              Discover what makes us the preferred partner for hospitality kitchen countertop solutions worldwide
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {/* Box 1: Premium material supplier */}
            <div className="group relative h-full">
              <div className="bg-primary rounded-2xl p-6 sm:p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col">
                ...
                <h3 className="text-lg sm:text-xl mb-3 sm:mb-4 leading-tight">
                  Premium material supplier
                </h3>
                <p className="text-white/90 leading-relaxed text-xs sm:text-sm flex-grow">
                  Specialized expertise in premium countertop materials for hospitality kitchens, ensuring top-quality granite, quartz, and solid surfaces.
                </p>
            ...
            {/* Box 2: Custom fabrication services */}
            <div className="group relative h-full">
              <div className="bg-primary rounded-2xl p-6 sm:p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col">
                <div className="bg-white/20 rounded-xl p-3 sm:p-4 w-fit mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <p className="text-white/90 leading-relaxed text-xs sm:text-sm flex-grow">
                  Precision cutting and edge finishing to match your exact kitchen dimensions and design specifications.
                </p>
                <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-30 transition-opacity duration-300">
            ...
            {/* Box 4: Professional installation included */}
            <div className="group relative h-full">
              <div className="bg-primary rounded-2xl p-6 sm:p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col">
                <div className="bg-white/20 rounded-xl p-3 sm:p-4 w-fit mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <p className="text-white/90 leading-relaxed text-xs sm:text-sm flex-grow">
                  Expert installation services ensuring perfect fit, proper sealing, and long-lasting performance for commercial kitchens.
                </p>
                <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-30 transition-opacity duration-300">
      ...
      {/* Enhanced Kitchen Countertops Collection Info Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-5xl mx-auto px-4 sm:px-0">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-8 text-white bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent leading-tight">
              Kitchen Countertops Collection: Where Durability Meets Performance
            </h2>
            <div className="space-y-4 sm:space-y-6 text-gray-300 text-sm sm:text-lg leading-relaxed">
              <p>
                Transform your hotel&apos;s kitchen operations with our meticulously crafted countertop collection, designed specifically for the hospitality industry&apos;s demanding requirements. Each countertop combines heat-resistant materials with hygienic surfaces, ensuring your kitchen staff experience both safety and professional functionality in food preparation.
              </p>
              <p>
                Our hotel kitchen countertops feature commercial-grade materials, including premium granite, engineered quartz, and stainless steel with heat-resistant properties and non-porous surfaces. The carefully selected materials resist staining, scratching, and bacterial growth, supporting your property&apos;s commitment to food safety standards and operational excellence.
              </p>
              <p>
                From intimate boutique hotels to grand resort properties, our collection offers versatile options that seamlessly integrate with any hospitality kitchen design. Whether you prefer natural stone elegance, modern engineered materials, or professional stainless steel, our kitchen countertops enhance your operational efficiency while delivering the durability and hygiene essential for commercial hospitality environments.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            ...
            <div className="flex-1 px-2 sm:px-0">
              <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-6 sm:mb-8 leading-tight text-center lg:text-left">Why Choose Our Hotel Kitchen Countertops</h2>
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Heat-resistant for commercial kitchens</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Engineered to withstand high temperatures from hot pots, pans, and commercial cooking equipment without damage.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Hygienic non-porous surfaces</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Non-porous materials prevent bacterial growth and ensure easy sanitization, meeting health department requirements.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Stain and scratch resistant</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Durable surfaces resist common kitchen stains and scratches, maintaining professional appearance over years of use.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Multiple material options</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Choose from granite, quartz, stainless steel, marble, and solid surface materials to match your kitchen needs.</p>
                  </div>
                </div>
              </div>
            </div>
            
            {/* Right side - Countertop Image */}
            <div className="flex-1 flex justify-center items-start">
              <div className="relative w-full max-w-lg">
                <ImageWithFallback
                  ...
                  alt="Premium Kitchen Countertop"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-8">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-3 text-foreground">
              Quality & Performance in Hotel Kitchen Countertops
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Where premium materials meet commercial kitchen demands
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="group text-center">
              ...
              <p className="text-sm text-muted-foreground">Top-grade granite, quartz, and solid surfaces ensure lasting quality</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <h3 className="font-bold mb-2 text-foreground">Food Safety</h3>
              <p className="text-sm text-muted-foreground">Non-porous surfaces meet health department standards and hygiene requirements</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <p className="text-sm text-muted-foreground">Durable construction maintains appearance and performance for decades</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <p className="text-sm text-muted-foreground">Meets hospitality industry standards for commercial kitchen surfaces</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 sm:py-16 bg-primary text-white">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-sm sm:text-xl mb-6 sm:mb-8 opacity-90 px-2 sm:px-0">
            Let&apos;s discuss how Sara Global Hospitality can bring your vision to life with our expert countertop<br className="hidden sm:block" />
      ...
      <section className="py-6 sm:py-12 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
              Quick answers to common questions about our kitchen countertop solutions
            </p>
          </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">What countertop materials are best for hotel commercial kitchens?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  For hotel commercial kitchens, we recommend engineered quartz for its non-porous surface and durability, granite for heat resistance and natural beauty, or stainless steel for professional food prep areas. Each material offers unique benefits depending on your specific kitchen operations and aesthetic preferences.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">Are your countertops heat-resistant for commercial cooking?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Yes! Our granite and quartz countertops are highly heat-resistant and can withstand hot pots and pans from commercial cooking equipment. Stainless steel options provide even greater heat tolerance. We recommend using trivets for extreme temperatures to maximize longevity.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">How do you ensure hygienic surfaces for food preparation?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  All our countertop materials are non-porous, preventing bacterial growth and ensuring easy sanitization. Quartz and solid surface options offer seamless integration with sinks, eliminating crevices where bacteria can hide. All materials are certified food-safe and meet health department requirements.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-4" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">What are the delivery timeframes for countertop orders in Canada?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  For Canadian hotel orders, standard countertop materials typically ship within 6-8 weeks. Custom fabrication including edge profiles and cutouts may require 8-12 weeks depending on complexity. We coordinate template measurements, fabrication, and installation with your project timeline. All shipments include professional logistics coordination across Canada.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
