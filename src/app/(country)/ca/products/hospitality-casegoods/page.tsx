...
export default function HospitalityCasegoodsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-3 md:px-4 text-center">
            <div className="max-w-2xl mx-auto px-3">
              <h1 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-white line-clamp-2 md:line-clamp-none">
                Hospitality Casegoods Collection
              </h1>
              <p className="text-sm md:text-lg lg:text-xl mb-5 md:mb-6 opacity-90 text-white">
                Premium casegoods designed for hotel guest rooms, combining functionality, style, and durability
              </p>
      ...
      <section className="py-6 md:py-12 bg-background">
        <div className="container mx-auto px-3 md:px-4">
          <div className="text-center mb-4 md:mb-8 px-3">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 line-clamp-2 md:line-clamp-none">Our Hospitality Casegoods</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {casegoods.map((casegood) => (
              <Card key={casegood.id} className="group overflow-hidden hover:shadow-lg transition-shadow duration-300 p-0">
                <div 
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <button 
                      className="bg-white/20 backdrop-blur-sm rounded-full p-2 shadow-lg opacity-0 group-hover/image:opacity-100 transition-opacity duration-200 hover:bg-white/30"
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                        handleImageZoom(casegood.image, casegood.name);
                      }}
                      aria-label="Zoom casegood image"
                    >
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between">
                    <h3 className="font-bold text-lg">{casegood.name}</h3>
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-xl md:text-3xl lg:text-4xl font-bold leading-tight text-center md:text-left line-clamp-2 md:line-clamp-none">
                  Transform Your Hotel with Premium Casegood Solutions
                </h2>
                <p className="text-sm md:text-lg text-muted-foreground mb-6 md:mb-8 text-center md:text-left">
                  Discover our comprehensive range of hotel casegoods designed to elevate your guest rooms&apos; functionality and aesthetic appeal. From modern dressers to classic wardrobes, we have everything you need.
                </p>
              </div>
      ...
      <section className="relative py-12 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        ...
        <div className="container mx-auto px-3 md:px-4 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-8 text-white bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent line-clamp-2 md:line-clamp-none">
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex-1">
              <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-8 line-clamp-2 md:line-clamp-none">Why Choose Our Hotel Casegoods</h2>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base md:text-lg font-bold mb-2">Built for commercial hospitality use</h3>
                    <p className="text-sm md:text-base text-muted-foreground">Engineered specifically for hotel environments, our casegoods withstand continuous daily use while maintaining structural integrity and aesthetic standards.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base md:text-lg font-bold mb-2">Premium materials and construction</h3>
                    <p className="text-sm md:text-base text-muted-foreground">Solid wood frames and high-quality veneers ensure exceptional durability and timeless beauty that enhances guest satisfaction.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base md:text-lg font-bold mb-2">Multiple finishes for brand alignment</h3>
                    <p className="text-sm md:text-base text-muted-foreground">Choose from walnut, oak, mahogany, cherry, and custom finishes to perfectly match your hotel&apos;s design aesthetic.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base md:text-lg font-bold mb-2">Easy installation and maintenance</h3>
                    <p className="text-sm md:text-base text-muted-foreground">Standard configurations and accessible components simplify installation and routine maintenance, reducing operational costs.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-6 md:py-12 relative overflow-hidden" style={{ backgroundColor: '#f9fafb' }}>
        ...
        <div className="container mx-auto px-3 md:px-4 relative z-10">
          <div className="text-center mb-4 md:mb-8 px-3">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-6 text-foreground line-clamp-2 md:line-clamp-none">
      ...
      <section className="py-10 md:py-16 bg-primary text-white">
        <div className="container mx-auto px-3 md:px-4 text-center">
          ...
          <p className="text-sm md:text-xl mb-6 md:mb-8 opacity-90">
            Let&apos;s discuss how Sara Global Hospitality can bring your vision to life with our expert casegood<br />
