...
export default function BreakfastChairsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Our Breakfast Chairs - Products Grid */}
      <section className="py-5 sm:py-8 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 leading-tight">Our Breakfast Chairs</h2>
              ...
              <Card key={chair.id} className="group overflow-hidden hover:shadow-lg transition-shadow duration-300 p-0">
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex items-center justify-between gap-2">
                    <h3 className="font-bold text-base sm:text-lg">{chair.name}</h3>
                    <Button 
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
              <div>
                <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold leading-tight mb-3 sm:mb-4 text-center lg:text-left">
      ...
      <section className="relative py-6 md:py-12 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-center">
            ...
            <div className="flex-1">
              <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-8 text-center md:text-left line-clamp-2 md:line-clamp-none">Why Choose Our Hotel Breakfast Chairs</h2>
      ...
      <section className="py-10 md:py-16 bg-primary text-white">
        <div className="container mx-auto px-3 md:px-4 text-center">
          <h2 className="text-xl md:text-3xl font-bold mb-3 md:mb-4 line-clamp-2 md:line-clamp-none px-3">Ready to Transform Your Hospitality Space?</h2>
      ...
      <section className="py-6 md:py-12 bg-slate-50">
        <div className="container mx-auto px-3 md:px-4">
          <div className="text-center mb-4 md:mb-8 px-3">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
              Quick answers to common questions about our breakfast chairs solutions
            </p>
          </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">How durable are your breakfast chairs for high-traffic hotel use?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Our breakfast chairs are specifically engineered for commercial hospitality environments with reinforced frames, commercial-grade upholstery, and heavy-duty construction. Each chair undergoes rigorous testing to withstand continuous daily use while maintaining structural integrity and comfort for years.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">Can you customize breakfast chairs to match our hotel&apos;s brand colors and design?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Absolutely! We offer extensive customization options including fabric selection from over 200 commercial-grade materials, custom finishes, brand color matching, and design modifications. Our team works closely with you to ensure the chairs perfectly align with your hotel&apos;s aesthetic and brand identity.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">What maintenance is required for hotel breakfast chairs?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Our breakfast chairs feature stain-resistant upholstery and easy-clean finishes that require minimal maintenance. Regular vacuuming and spot cleaning with mild detergent is typically sufficient. We provide detailed care instructions and recommend professional deep cleaning annually for optimal longevity.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-4" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">What are your delivery timeframes for large hotel orders in Canada?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  For Canadian hotel orders, standard breakfast chair collections typically ship within 6-8 weeks. Custom orders may require 10-14 weeks depending on specifications and quantity. We offer expedited production for urgent projects and provide detailed delivery schedules during the quotation process. All shipments include professional logistics coordination across Canada.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
