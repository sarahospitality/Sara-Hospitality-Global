...
const mirrors = [
  {
    ...
    image: "https://images.unsplash.com/photo-1631889992457-f4cf52f0ee5a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiYXRocm9vbSUyMG1pcnJvciUyMExFRCUyMGhvdGVsfGVufDF8fHx8MTc1NzU5MTE0MHww&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmcmFtZWxlc3MlMjBtaXJyb3IlMjBiYXRocm9vbXxlbnwxfHx8fDE3NTc1OTExNDN8MA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1585128903994-3cfabb986cbd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtYWtldXAlMjBtaXJyb3IlMjBiYXRocm9vbXxlbnwxfHx8fDE3NTc1OTExNDd8MA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1605296867424-35fc25c9212a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbWFydCUyMG1pcnJvciUyMGRpc3BsYXl8ZW58MXx8fHwxNzU3NTkxMTUwfDA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1604709177595-c90acbddc2c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmdWxsJTIwbGVuZ3RoJTIwbWlycm9yJTIwaG90ZWx8ZW58MXx8fHwxNzU3NTkxMTU0fDA&ixlib=rb-4.1.0&q=80&w=1080",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1618220179428-22790b461013?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZWNvcmF0aXZlJTIwbWlycm9yJTIwaG90ZWx8ZW58MXx8fHwxNzU3NTkxMTU3fDA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[40vh] overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1631889992457-f4cf52f0ee5a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwyfHxob3RlbCUyMGJhdGhyb29tJTIwbWlycm9yJTIwbHV4dXJ5fGVufDF8fHx8MTc1NzU5MTE2MHww&ixlib=rb-4.1.0&q=80&w=1080"
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-10">
            ...
            <div className="text-center">
              <div className="bg-white/95 backdrop-blur-sm p-3 sm:p-4 md:p-6 rounded-xl shadow-2xl border border-white/20">
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-primary mb-1">100%</div>
                <div className="text-xs sm:text-sm text-muted-foreground">Premium Glass</div>
              </div>
            </div>
      ...
      <section className="py-5 sm:py-8 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4 leading-tight">Our Mirrors</h2>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
              Discover our comprehensive range of mirrors, each designed with unique features to meet your hospitality fixture needs.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {mirrors.map((mirror) => (
              <Card key={mirror.id} className="group overflow-hidden hover:shadow-lg transition-shadow duration-300 p-0">
                <div 
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex items-center justify-between gap-2">
                    <h3 className="font-bold text-base sm:text-lg">{mirror.name}</h3>
      ...
      <section className="py-5 sm:py-10 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {/* Box 1: Premium glass manufacturer */}
            ...
            {/* Box 3: International hotel experience */}
            <div className="group relative h-full">
              <div className="bg-primary rounded-2xl p-6 sm:p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col">
                <div className="bg-white/20 rounded-xl p-3 sm:p-4 w-fit mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            {/* Box 4: Quality assurance and safe delivery */}
            <div className="group relative h-full">
              <div className="bg-primary rounded-2xl p-6 sm:p-8 text-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col">
                <div className="bg-white/20 rounded-xl p-3 sm:p-4 w-fit mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-5xl mx-auto px-4 sm:px-0">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-8 text-white bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent leading-tight">
              Mirrors Collection: Where Reflection Meets Innovation
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div className="flex-1 px-2 sm:px-0">
              <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-6 sm:mb-8 leading-tight text-center lg:text-left">Why Choose Our Hotel Mirrors</h2>
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Premium quality glass construction</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">High-grade glass with superior clarity and minimal distortion ensures guests see their true reflection every time.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Anti-fog and moisture-resistant</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Advanced coatings prevent fogging and resist moisture damage, maintaining crystal-clear reflections in humid bathroom environments.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Integrated LED lighting options</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Optional LED backlighting provides perfect illumination for grooming while adding a touch of modern luxury to bathroom spaces.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Custom sizing and shapes available</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Flexible customization options ensure perfect fit for any bathroom design, from standard rectangles to unique custom shapes.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="group text-center">
              ...
              <h3 className="font-bold mb-2 text-foreground">Crystal Clarity</h3>
      ...
      <section className="py-8 sm:py-16 bg-primary text-white">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-sm sm:text-xl mb-6 sm:mb-8 opacity-90 px-2 sm:px-0">
            Let&apos;s discuss how Sara Global Hospitality can bring your vision to life with our expert mirror<br className="hidden sm:block" />
      ...
      <section className="py-6 sm:py-12 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
              Quick answers to common questions about our mirror solutions
            </p>
          </div>
