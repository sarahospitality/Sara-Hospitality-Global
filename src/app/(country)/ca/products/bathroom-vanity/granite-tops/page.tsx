...
const graniteTops = [
  {
    id: "gt-401",
    name: "GT-401",
    category: "Black Galaxy Granite",
    description: "Premium black galaxy granite countertop with stunning gold specks. Perfect for luxury hotel bathrooms seeking dramatic elegance.",
    features: ["Natural Gold Specks", "Heat Resistant", "Unique Patterns", "Luxury Appeal"],
    image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
    tags: ["Black", "Luxury", "Natural"]
  },
  {
    id: "gt-402",
    name: "GT-402",
    category: "Kashmir White Granite",
    description: "Elegant Kashmir white granite with subtle grey veining. Ideal for creating bright, sophisticated hotel bathroom spaces.",
    features: ["White Base", "Grey Veining", "Bright Finish", "Sophisticated"],
    image: "https://images.unsplash.com/photo-1556912998-c57cc6b63cd7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
    tags: ["White", "Bright", "Elegant"]
  },
  {
    id: "gt-403",
    name: "GT-403",
    category: "Absolute Black Granite",
    description: "Pure absolute black granite countertop offering timeless elegance. Perfect for modern minimalist hotel bathroom designs.",
    features: ["Pure Black", "Minimalist", "Polished Finish", "Timeless"],
    image: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
    tags: ["Black", "Modern", "Minimalist"]
  },
  {
    id: "gt-404",
    name: "GT-404",
    category: "Tan Brown Granite",
    description: "Warm tan brown granite with rich color variations. Creates inviting, earthy atmosphere in hotel bathrooms.",
    features: ["Warm Tones", "Color Variation", "Natural Beauty", "Earthy"],
    image: "https://images.unsplash.com/photo-1620626011761-996317b8d101?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
    tags: ["Brown", "Warm", "Natural"]
  },
  {
    id: "gt-405",
    name: "GT-405",
    category: "Blue Pearl Granite",
    description: "Exotic blue pearl granite featuring unique blue shimmer. Adds distinctive luxury to upscale hotel bathrooms.",
    features: ["Blue Shimmer", "Exotic", "Unique Pattern", "Luxury"],
    image: "https://images.unsplash.com/photo-1565183997392-2f5d9f2f7f4f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
    tags: ["Blue", "Exotic", "Premium"]
  },
  {
    id: "gt-406",
    name: "GT-406",
    category: "Imperial Red Granite",
    description: "Bold imperial red granite making powerful design statements. Perfect for boutique hotels seeking distinctive bathroom aesthetics.",
    features: ["Bold Red", "Statement Piece", "Distinctive", "Premium"],
    image: "https://images.unsplash.com/photo-1603357841205-6e91466d1e91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080&q=80",
    tags: ["Red", "Bold", "Boutique"]
  }
];

export default function GraniteTopsPage() {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[40vh] overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1920&q=80"
            alt="Granite Tops Collection"
          ...
          <div className="container mx-auto px-4 sm:px-6 text-center">
            <div className="max-w-2xl mx-auto px-2 sm:px-0">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 text-white leading-tight">
                Granite Tops Collection
              </h1>
              <p className="text-sm sm:text-lg lg:text-xl mb-4 sm:mb-6 opacity-90 text-white px-2 sm:px-0">
                Premium granite countertops for hotel bathroom vanities, featuring natural stone beauty and exceptional durability
              </p>
      ...
      {/* Our Granite Tops - Products Grid */}
      <section className="py-5 sm:py-8 bg-background">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-3 sm:mb-4 leading-tight">Our Granite Tops</h2>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
              Discover our comprehensive range of premium granite countertops, each featuring unique natural patterns to meet your hospitality bathroom needs.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {graniteTops.map((granite) => (
              <Card key={granite.id} className="group overflow-hidden hover:shadow-lg transition-shadow duration-300 p-0">
                <div 
                  className="relative cursor-pointer group/image overflow-hidden m-0"
                  onClick={() => handleImageClick(granite.image, granite.name)}
                >
                  <ImageWithFallback
                    src={granite.image}
                    alt={granite.name}
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex items-center justify-between gap-2">
                    <h3 className="font-bold text-base sm:text-lg">{granite.name}</h3>
                    <Button 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
              <div>
                <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold leading-tight mb-3 sm:mb-4 text-center lg:text-left">
                  Transform Your Hotel Bathrooms with Premium Granite
                </h2>
                <p className="text-sm sm:text-lg text-muted-foreground mb-4 sm:mb-8 text-center lg:text-left">
                  Discover our comprehensive range of natural granite countertops designed to elevate your hotel bathrooms with timeless beauty and unmatched durability.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=800&q=80"
                  alt="Premium granite countertop for hotel bathroom"
                  className="w-full h-full object-cover"
                  width={800}
                  height={600}
                />
      ...
      {/* Enhanced Granite Tops Collection Info Section */}
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center max-w-5xl mx-auto px-4 sm:px-0">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-8 text-white bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent leading-tight">
              Granite Tops Collection: Where Natural Beauty Meets Hospitality Excellence
            </h2>
            <div className="space-y-4 sm:space-y-6 text-gray-300 text-sm sm:text-lg leading-relaxed">
              <p>
                Transform your hotel&apos;s bathroom spaces with our premium granite countertop collection, sourced from the finest quarries worldwide. Each slab showcases nature&apos;s artistry with unique patterns and color variations, ensuring your hotel bathrooms feature one-of-a-kind luxury that guests will remember.
              </p>
              <p>
                Our granite tops feature exceptional durability and heat resistance, making them ideal for high-traffic hotel environments. The natural stone&apos;s inherent strength withstands daily use while maintaining its polished beauty, and the non-porous sealed surface resists stains and bacteria, supporting your hotel&apos;s hygiene standards.
              </p>
              <p>
                From intimate boutique hotels to grand luxury resorts, our granite collection offers diverse colors and patterns that complement any bathroom aesthetic. Whether you prefer classic blacks and whites, warm earth tones, or exotic blues and reds, our granite tops elevate your bathroom design while delivering the longevity and performance essential for commercial hospitality environments.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div className="flex-1 px-2 sm:px-0">
              <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-6 sm:mb-8 leading-tight text-center lg:text-left">Why Choose Our Hotel Granite Tops</h2>
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Natural beauty with unique patterns</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Each granite slab features distinctive natural patterns and color variations, ensuring your hotel bathrooms showcase one-of-a-kind luxury.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Exceptional durability and longevity</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Granite&apos;s inherent strength withstands decades of daily hotel use, heat, and scratches while maintaining its polished appearance.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Hygienic and easy to maintain</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Properly sealed granite surfaces resist bacteria and stains, requiring only simple cleaning to maintain pristine condition in hotel bathrooms.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-3 h-3 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                  <div>
                    <h3 className="text-base sm:text-lg font-bold mb-1 sm:mb-2">Adds significant property value</h3>
                    <p className="text-sm sm:text-base text-muted-foreground">Premium granite countertops enhance guest perception and allow premium room rates while increasing overall property value.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 flex justify-center items-start">
              <div className="relative w-full max-w-lg">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1584622650111-993a426fbf0a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=600&q=80"
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3 text-foreground leading-tight">
              Premium Granite Features for Hotels
            </h2>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
              Where nature&apos;s artistry meets hospitality excellence
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto">
            <div className="group text-center">
              ...
              <h3 className="font-bold mb-2 text-foreground">Natural Stone</h3>
              <p className="text-sm text-muted-foreground">Authentic natural granite with unique patterns in every slab</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <p className="text-sm text-muted-foreground">Luxury granite elevates bathroom experience and guest reviews</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <h3 className="font-bold mb-2 text-foreground">Long-lasting Beauty</h3>
              <p className="text-sm text-muted-foreground">Decades of durability maintaining pristine appearance</p>
            </div>
            ...
            <div className="group text-center">
              ...
              <h3 className="font-bold mb-2 text-foreground">Premium Quality</h3>
              <p className="text-sm text-muted-foreground">Sourced from world-class quarries for superior quality</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 sm:py-12 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-6 sm:mb-8 px-4 sm:px-0">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto px-2 sm:px-0">
              Quick answers to common questions about our granite countertops
            </p>
          </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">How durable is granite for high-traffic hotel bathroom use?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Granite is one of the most durable natural stones available, making it ideal for hotel bathrooms. It resists scratches, heat, and daily wear exceptionally well. With proper sealing and maintenance, granite countertops can last decades in commercial hospitality environments while maintaining their polished appearance.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">Can granite countertops be customized for our hotel bathrooms?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Yes! We offer complete customization including slab selection from diverse colors and patterns, custom edge profiles, integrated sink cutouts, and precise sizing to fit your bathroom layouts. Our team works with you to select granite that perfectly matches your hotel&apos;s aesthetic vision.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">What maintenance is required for hotel granite countertops?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Granite countertops require minimal maintenance. Daily cleaning with mild soap and water is sufficient. We recommend professional resealing annually to maintain water and stain resistance. We provide detailed care instructions and can arrange professional maintenance services for your hotel.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-4" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">What are the delivery and installation timeframes for granite tops in Canada?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  For Canadian hotel projects, granite countertop fabrication and delivery typically takes 4-6 weeks after template approval. Large-scale projects may require 8-10 weeks depending on quantity and customization. We coordinate professional installation and provide detailed project timelines during the quotation process.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
