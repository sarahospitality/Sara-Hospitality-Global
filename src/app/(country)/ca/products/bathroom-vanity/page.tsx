...
const buyingGuideContent = {
  1: {
    title: "How to Choose the Right Hotel Bathroom Vanity Design",
    subtitle: "Design Selection Excellence",
    content: [
      "Consider your hotel's brand identity and bathroom space requirements to select vanities that align with your overall aesthetic vision and functional needs.",
      "Evaluate plumbing configurations and storage needs to ensure optimal vanity placement that enhances guest convenience and bathroom functionality.",
      "Choose versatile designs that can adapt to different room types - from standard rooms to luxury suites - maximizing your investment's functionality."
    ]
  },
  2: {
    ...
    content: [
      "Bulk orders offer cost-effectiveness and faster delivery times, making them ideal for large-scale hotel projects with standardized bathroom designs across multiple rooms.",
      "Custom manufacturing provides unique vanity designs tailored to your specific brand requirements, allowing for specialized dimensions, materials, and finishes that perfectly match your vision.",
      "Consider hybrid approaches where standard vanity bases are customized with your preferred countertops and finishes, balancing cost efficiency with brand personalization."
    ]
  },
  3: {
    title: "Key Considerations: Durability, Water Resistance, Guest Experience & Budget",
    subtitle: "Comprehensive Evaluation Framework",
    content: [
      "Durability assessment should focus on water-resistant materials, solid construction, and moisture-proof finishes that can withstand constant bathroom use while maintaining appearance.",
      "Water resistance requirements must include waterproof sealants, proper drainage systems, and easy-to-clean surfaces that support housekeeping efficiency.",
...
const products = [
  {
    id: "granite-tops",
    name: "Granite Tops",
    category: "granite-tops",
    description: "Premium granite countertops for hotel bathroom vanities, featuring natural stone beauty, exceptional durability, and timeless elegance perfect for luxury hospitality environments.",
    features: ["Natural Stone", "Heat Resistant", "Scratch Resistant", "Luxury Finish"],
    image: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxncmFuaXRlJTIwY291bnRlcnRvcCUyMGJhdGhyb29tfGVufDB8fHx8MTczMDc0MTIwMHww&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Premium", "Natural Stone", "Durable"]
  },
  {
    id: "quartz-tops",
    name: "Quartz Tops",
    category: "quartz-tops",
    description: "Engineered quartz countertops offering superior stain resistance, low maintenance, and consistent patterns ideal for modern hotel bathroom designs.",
    features: ["Stain Resistant", "Low Maintenance", "Non-Porous", "Uniform Patterns"],
    image: "https://images.unsplash.com/photo-1604709177225-055f99402ea3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxxdWFydHolMjBjb3VudGVydG9wJTIwYmF0aHJvb218ZW58MHx8fHwxNzMwNzQxMjAwfDA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Modern", "Hygienic", "Consistent"]
  },
  {
    id: "wood-vanity-bases",
    name: "Wood Vanity Bases",
    category: "wood-vanity-bases",
    description: "Solid wood vanity bases featuring expert craftsmanship, moisture-resistant finishes, and elegant storage solutions perfect for hospitality bathroom environments.",
    features: ["Solid Wood", "Moisture Resistant", "Custom Storage", "Expert Craftsmanship"],
    image: "https://images.unsplash.com/photo-1620626011761-996317b8d101?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3b29kJTIwdmFuaXR5JTIwYmF0aHJvb218ZW58MHx8fHwxNzMwNzQxMjAwfDA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Classic", "Storage", "Premium"]
  }
];
...
export default function BathroomVanityPage() {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[40vh] overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiYXRocm9vbSUyMHZhbml0eSUyMGhvdGVsJTIwbHV4dXJ5fGVufDB8fHx8MTczMDc0MTIwMHww&ixlib=rb-4.1.0&q=80&w=1080"
            alt="Bathroom Vanity Collection Showroom"
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-sm md:text-lg lg:text-xl mb-4 md:mb-6 opacity-90 text-white text-center">
                Premium bathroom vanities designed for durability, style, and hospitality excellence
              </p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex">
                      <Link 
                        href={
                          product.id === 'granite-tops' ? '/ca/products/bathroom-vanity/granite-tops' :
                          product.id === 'quartz-tops' ? '/ca/products/bathroom-vanity/quartz-tops' :
                          product.id === 'wood-vanity-bases' ? '/ca/products/bathroom-vanity/wood-vanity-bases' :
                          '#'
                        } 
                        className="flex-1"
                      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6 leading-tight text-center md:text-left line-clamp-2 md:line-clamp-none">
                  Transform Your Hotel Bathrooms with Premium Vanity Solutions
                </h2>
                <p className="text-sm md:text-lg text-muted-foreground mb-6 md:mb-8 text-center md:text-left">
                  Discover our comprehensive range of bathroom vanity options designed to elevate your guests&apos; experience and enhance your hotel&apos;s aesthetic appeal. From granite tops to custom wood bases, we have everything you need.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1594026112284-02bb6f3352fe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBiYXRocm9vbSUyMHZhbml0eSUyMGhvdGVsfGVufDB8fHx8MTczMDc0MTIwMHww&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Modern luxury bathroom vanity for hotel"
                  className="w-full h-full object-cover"
                  width={800}
                  height={600}
                />
      ...
      {/* Why Hotel Bathroom Vanities Matter Section */}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 px-2">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6 leading-tight line-clamp-2 md:line-clamp-none">
              Why Hotel Bathroom Vanities Matter
            </h2>
            <p className="text-sm md:text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover the key factors that make quality bathroom vanities essential for modern hospitality success
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 text-black shadow-lg border">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Quality bathroom vanities create memorable first impressions and enhance overall guest satisfaction with superior functionality and aesthetics.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 text-black shadow-lg border">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Cohesive vanity design reinforces your hotel brand identity and creates a unified aesthetic experience across all guest rooms.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 text-black shadow-lg border">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 font-semibold">Years Durability &<br/>Water Resistance</div>
                </div>
              </div>
              <p className="text-sm text-gray-500 leading-relaxed">
                Commercial-grade bathroom vanities withstand heavy daily use and moisture while requiring minimal maintenance, protecting your long-term investment.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 text-black shadow-lg border">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Smart vanity solutions streamline housekeeping processes and maintenance, reducing operational costs and improving staff productivity.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 text-black shadow-lg border">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Premium bathroom vanities increase guest satisfaction scores, repeat bookings, and positive reviews, delivering significant returns on your investment.
              </p>
            </div>

            {/* Blends Style & Functionality */}
            <div className="bg-white rounded-2xl p-6 text-black shadow-lg border">
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-primary rounded-xl p-3">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Modern bathroom vanities perfectly balance aesthetic appeal with practical storage and functionality, creating beautiful spaces that guests love.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Hospitality Bathroom Vanity Buying Guide Section */}
      <section className="py-8 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 px-2">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6 leading-tight line-clamp-2 md:line-clamp-none">
              Hospitality Bathroom Vanity Buying Guide for Hotel Owners
            </h2>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-gray-900">How to choose the right hotel Bathroom Vanity design</h3>
                ...
                >
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-3 text-gray-900">Key considerations: durability, water resistance, guest experience, budget</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Comprehensive evaluation framework covering all critical factors for successful vanity investment decisions.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:h-[591px]">
            ...
            <div className="flex flex-col space-y-6 h-full">
              ...
              <div className="relative rounded-2xl overflow-hidden flex-1">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1507652313519-d4e9174996dd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBob3RlbCUyMGJhdGhyb29tJTIwdmFuaXR5fGVufDB8fHx8MTczMDc0MTIwMHww&ixlib=rb-4.1.0&q=80&w=1080"
                  alt="Luxury Hotel Bathroom Vanity"
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="text-center mb-4 md:mb-8 px-3">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
              Quick answers to common questions about our bathroom vanity solutions
            </p>
          </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">What makes hotel bathroom vanities different from residential vanities?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Hotel bathroom vanities are specifically designed for high-traffic commercial use with enhanced water resistance, durable finishes, reinforced construction, and easy maintenance features. Our pieces undergo rigorous testing to meet hospitality industry standards.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="bg-white rounded-lg border px-6">
                ...
                <AccordionContent className="text-muted-foreground pb-4">
                  Standard bathroom vanity collections ship within 4-6 weeks. Custom pieces may take 8-12 weeks depending on specifications. We provide detailed timelines during the quotation process and offer rush delivery options when needed.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">Do you offer customization options?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  Yes! We offer extensive customization including countertop materials (granite, quartz, marble), vanity base finishes, storage configurations, and sizing. Our design team can help you create the perfect vanity that matches your hotel&apos;s aesthetic and functional requirements.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-4" className="bg-white rounded-lg border px-6">
                <AccordionTrigger className="text-left hover:no-underline py-4">
                  <span className="font-medium">What warranty do you provide on bathroom vanities?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground pb-4">
                  We provide a comprehensive 10-year structural warranty and 5-year finish warranty. This includes free repairs or replacements for manufacturing defects and normal commercial wear under proper care and maintenance.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
