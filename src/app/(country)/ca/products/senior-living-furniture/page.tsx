...
const seniorLivingFurniture = [
  {
    id: "sl-101",
    name: "SL-101",
    category: "Accessible Armchair",
    description: "Ergonomic armchair designed for senior comfort with higher seat height and armrests for easy standing.",
    features: ["Higher Seat", "Sturdy Armrests", "Easy Care Fabric", "Stable Base"],
    image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzZW5pb3IlMjBjaGFpciUyMGNvbWZvcnR8ZW58MXx8fHwxNzU3NTkxMDgwfDA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Accessible", "Comfort", "Safety"]
  },
  {
    id: "sl-102",
    name: "SL-102",
    category: "Safety Bed Frame",
    description: "Low-profile bed frame with safety rails designed to prevent falls while ensuring comfort and ease of access.",
    features: ["Low Height", "Safety Rails", "Sturdy Construction", "Easy Access"],
    image: "https://images.unsplash.com/photo-1505693314120-0d443867891c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxiZWQlMjBmcmFtZSUyMHNhZmV0eXxlbnwxfHx8fDE3NTc1OTEwODN8MA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Safety", "Accessible", "Durable"]
  },
  {
    id: "sl-103",
    name: "SL-103",
    category: "Dining Chair Collection",
    description: "Supportive dining chairs with ergonomic back support and stable construction for senior living dining areas.",
    features: ["Ergonomic Support", "Non-Slip Feet", "Easy to Clean", "Comfortable"],
    image: "https://images.unsplash.com/photo-1503602642458-232111445657?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaW5pbmclMjBjaGFpciUyMGNvbWZvcnR8ZW58MXx8fHwxNzU3NTkxMDg3fDA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Dining", "Ergonomic", "Safe"]
  },
  {
    id: "sl-104",
    name: "SL-104",
    category: "Mobility-Friendly Tables",
    description: "Height-adjustable tables accommodating wheelchairs and walkers with rounded edges for safety.",
    features: ["Adjustable Height", "Wheelchair Accessible", "Rounded Edges", "Stable"],
    image: "https://images.unsplash.com/photo-1617806118337-2e235b6e4c5a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhZGp1c3RhYmxlJTIwdGFibGV8ZW58MXx8fHwxNzU3NTkxMDkwfDA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Accessible", "Adjustable", "Safe"]
  },
  {
    id: "sl-105",
    name: "SL-105",
    category: "Memory Care Seating",
    description: "Specially designed seating for memory care units with calming colors and secure, comfortable construction.",
    features: ["Calming Design", "Secure Construction", "Easy Maintenance", "Durable"],
    image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21mb3J0JTIwY2hhaXIlMjBzZW5pb3J8ZW58MXx8fHwxNzU3NTkxMDkzfDA&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Memory Care", "Comfort", "Secure"]
  },
  {
    id: "sl-106",
    name: "SL-106",
    category: "Assisted Storage Units",
    description: "Easy-access storage solutions with pull-out drawers and organized compartments for assisted living residents.",
    features: ["Easy Access", "Pull-Out Drawers", "Organized", "Senior-Friendly"],
    image: "https://images.unsplash.com/photo-1595428774223-ef52624120d2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdG9yYWdlJTIwZnVybml0dXJlfGVufDF8fHx8MTc1NzU5MTA5N3ww&ixlib=rb-4.1.0&q=80&w=1080",
    tags: ["Storage", "Accessible", "Practical"]
  }
];

export default function SeniorLivingFurniturePage() {
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[40vh] overflow-hidden">
        <div className="absolute inset-0">
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1555041469-a586c61ea9bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzZW5pb3IlMjBjaGFpciUyMGNvbWZvcnR8ZW58MXx8fHwxNzU3NTkxMDgwfDA&ixlib=rb-4.1.0&q=80&w=1080"
            alt="Senior Living Furniture Collection"
          ...
          <div className="container mx-auto px-3 md:px-4 text-center">
            <div className="max-w-2xl mx-auto px-3">
              <h1 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-white line-clamp-2 md:line-clamp-none">
                Senior Living Furniture Collection
              </h1>
              <p className="text-sm md:text-lg lg:text-xl mb-5 md:mb-6 opacity-90 text-white">
                Accessible, safe, and comfortable furniture designed specifically for senior living communities
              </p>
      ...
      <section className="py-6 md:py-12 bg-background">
        <div className="container mx-auto px-3 md:px-4">
          <div className="text-center mb-4 md:mb-8 px-3">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 line-clamp-2 md:line-clamp-none">Our Senior Living Furniture</h2>
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
              Discover our comprehensive range of senior living furniture, each designed with accessibility and safety to meet your facility needs.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {seniorLivingFurniture.map((furniture) => (
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-xl md:text-3xl lg:text-4xl font-bold leading-tight text-center md:text-left line-clamp-2 md:line-clamp-none">
                  Transform Your Senior Living Facility with Safe Solutions
                </h2>
                <p className="text-sm md:text-lg text-muted-foreground mb-6 md:mb-8 text-center md:text-left">
                  Discover our comprehensive range of senior living furniture designed to enhance safety, accessibility, and comfort for your residents.
                </p>
              </div>
        ...
        <div className="container mx-auto px-3 md:px-4 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-8 text-white bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              Senior Living Furniture: Where Safety Meets Comfort
            </h2>
            <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
              <p>
                Transform your senior living facility with our meticulously crafted furniture collection, designed specifically for the unique needs of senior residents. Each piece combines accessibility features with comfort, ensuring your residents experience both safety and dignity.
              </p>
              <p>
                Our senior living furniture features thoughtful construction, including higher seat heights, sturdy armrests, rounded edges, and non-slip feet that accommodate mobility challenges while maintaining elegant aesthetics. The carefully engineered designs promote independence and comfort, supporting your facility&apos;s mission of care.
              </p>
              <p>
                From assisted living communities to memory care units, our collection offers designs that seamlessly integrate safety with hospitality aesthetics. Whether you need accessible seating, safety beds, or mobility-friendly tables, our furniture enhances resident quality of life while delivering the durability essential for senior living environments.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-3 md:px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex-1">
              <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-8">Why Choose Our Senior Living Furniture</h2>
              <div className="space-y-6">
        ...
        <div className="container mx-auto px-3 md:px-4 relative z-10">
          <div className="text-center mb-4 md:mb-8 px-3">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 text-foreground">
              Quality & Performance in Senior Living Furniture
            </h2>
      ...
      <section className="py-10 md:py-16 bg-primary text-white">
        <div className="container mx-auto px-3 md:px-4 text-center">
          <h2 className="text-xl md:text-3xl font-bold mb-3 md:mb-4 line-clamp-2 md:line-clamp-none">Ready to Transform Your Senior Living Facility?</h2>
          <p className="text-sm md:text-xl mb-6 md:mb-8 opacity-90">
            Let&apos;s discuss how Sara Global Hospitality can bring your vision to life with our expert senior living<br />
            furniture solutions and specialized experience.
          </p>
          <div className="flex justify-center">
      ...
      <section className="py-6 md:py-12 bg-slate-50">
        <div className="container mx-auto px-3 md:px-4">
          <div className="text-center mb-4 md:mb-8 px-3">
            ...
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
              Quick answers to common questions about our senior living furniture solutions
            </p>
          </div>
