...
export default function BedroomHotelFurniturePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-3 md:px-4 text-center">
            <div className="max-w-2xl mx-auto px-3">
              <h1 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-white line-clamp-2 md:line-clamp-none">
                Bedroom Hotel Furniture Collection
              </h1>
              <p className="text-sm md:text-lg lg:text-xl mb-5 md:mb-6 opacity-90 text-white">
                Complete bedroom furniture solutions for hotel guest rooms, combining luxury, comfort, and functionality
              </p>
      ...
      <section className="py-6 md:py-12 bg-background">
        <div className="container mx-auto px-3 md:px-4">
          <div className="text-center mb-4 md:mb-8 px-3">
            <h2 className="text-xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 line-clamp-2 md:line-clamp-none">Our Bedroom Furniture</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {bedroomFurniture.map((furniture) => (
            ...
            <div className="space-y-6">
              <div>
                <h2 className="text-xl md:text-3xl lg:text-4xl font-bold leading-tight text-center md:text-left line-clamp-2 md:line-clamp-none">
                  Transform Your Hotel with Premium Bedroom Solutions
                </h2>
                <p className="text-sm md:text-lg text-muted-foreground mb-6 md:mb-8 text-center md:text-left">
                  Discover our comprehensive range of bedroom furniture designed to elevate your guest rooms&apos; functionality and aesthetic appeal. From modern dressers to classic wardrobes, we have everything you need.
                </p>
              </div>
      ...
      <section className="py-10 md:py-16 bg-primary text-white">
        <div className="container mx-auto px-3 md:px-4 text-center">
          <h2 className="text-xl md:text-3xl font-bold mb-3 md:mb-4 line-clamp-2 md:line-clamp-none">Ready to Transform Your Hotel Rooms?</h2>
          <p className="text-sm md:text-xl mb-6 md:mb-8 opacity-90">
            Let&apos;s discuss how Sara Global Hospitality can bring your vision to life with our expert bedroom<br />
