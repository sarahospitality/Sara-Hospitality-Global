...
interface CanadianStatsSectionProps {
  selectedCountry?: string;
}

export default function CanadianStatsSection({ selectedCountry }: CanadianStatsSectionProps) {
  ...
  return (
    <>
      {/* Stats Section - Remove blue background */}
